...
namespace Base.Ravel.Creator.Components
{
	...
	public partial class CopyTransformComponent : ComponentBase
	{
		...
		/// <summary>
		/// Manually copies the values of the transform, even when the script is not active.
		/// </summary>
		public void CopyValues() { }

		/// <summary>
		/// Sets the transform that this object copies the value of.
		/// </summary>
		/// <param name="transform"></param>
		public void SetCopyTransform(Transform transform) { }

		/// <summary>
		/// Starts or stops copying the transform values (during the update loop).
		/// </summary>
		/// <param name="active">True/False should transform values be copied.</param>
